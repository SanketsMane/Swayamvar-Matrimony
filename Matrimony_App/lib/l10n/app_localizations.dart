...
abstract class AppLocalizations {
  ...
  /// No description provided for @common_password_mismatch.
  ///
  /// In en, this message translates to:
  /// **'Passwords do not match'**
  String get common_password_mismatch;

  /// No description provided for @common_password_enter_confirm.
  ///
  /// In en, this message translates to:
  /// **'Please enter confirm password'**
  String get common_password_enter_confirm;

  /// No description provided for @common_did_not_receive_code.
  ///
  /// In en, this message translates to:
  /// **'Didn\'t receive code?'**
  String get common_did_not_receive_code;
  ...
  /// No description provided for @marital_status_unmarried.
  ///
  /// In en, this message translates to:
  /// **'Unmarried'**
  String get marital_status_unmarried;

  /// No description provided for @marital_status_divorced_m.
  ///
  /// In en, this message translates to:
  /// **'Divorced (M)'**
  String get marital_status_divorced_m;

  /// No description provided for @marital_status_divorced_f.
  ///
  /// In en, this message translates to:
  /// **'Divorced (F)'**
  String get marital_status_divorced_f;

  /// No description provided for @marital_status_widow.
  ///
  /// In en, this message translates to:
  /// **'Widow'**
  String get marital_status_widow;

  /// No description provided for @marital_status_widower.
  ///
  /// In en, this message translates to:
  /// **'Widower'**
  String get marital_status_widower;

  /// No description provided for @complexion_fair.
  ///
  /// In en, this message translates to:
  /// **'Fair'**
  String get complexion_fair;

  /// No description provided for @complexion_medium.
  ///
  /// In en, this message translates to:
  /// **'Medium'**
  String get complexion_medium;

  /// No description provided for @complexion_wheatish.
  ///
  /// In en, this message translates to:
  /// **'Wheatish'**
  String get complexion_wheatish;

  /// No description provided for @complexion_dark.
  ///
  /// In en, this message translates to:
  /// **'Dark'**
  String get complexion_dark;

  /// No description provided for @education_illiterate.
  ///
  /// In en, this message translates to:
  /// **'Illiterate'**
  String get education_illiterate;

  /// No description provided for @education_primary.
  ///
  /// In en, this message translates to:
  /// **'Primary'**
  String get education_primary;

  /// No description provided for @education_secondary.
  ///
  /// In en, this message translates to:
  /// **'Secondary'**
  String get education_secondary;

  /// No description provided for @education_higher_secondary.
  ///
  /// In en, this message translates to:
  /// **'Higher Secondary'**
  String get education_higher_secondary;

  /// No description provided for @education_graduate.
  ///
  /// In en, this message translates to:
  /// **'Graduate'**
  String get education_graduate;

  /// No description provided for @education_post_graduate.
  ///
  /// In en, this message translates to:
  /// **'Post Graduate'**
  String get education_post_graduate;

  /// No description provided for @education_doctorate.
  ///
  /// In en, this message translates to:
  /// **'Doctorate'**
  String get education_doctorate;

  /// No description provided for @education_other.
  ///
  /// In en, this message translates to:
  /// **'Other'**
  String get education_other;

  /// No description provided for @occupation_private.
  ///
  /// In en, this message translates to:
  /// **'Private Job'**
  String get occupation_private;

  /// No description provided for @occupation_government.
  ///
  /// In en, this message translates to:
  /// **'Government Job'**
  String get occupation_government;

  /// No description provided for @occupation_business.
  ///
  /// In en, this message translates to:
  /// **'Business'**
  String get occupation_business;

  /// No description provided for @occupation_self_employed.
  ///
  /// In en, this message translates to:
  /// **'Self Employed'**
  String get occupation_self_employed;

  /// No description provided for @occupation_farmer.
  ///
  /// In en, this message translates to:
  /// **'Farmer'**
  String get occupation_farmer;

  /// No description provided for @occupation_teacher.
  ///
  /// In en, this message translates to:
  /// **'Teacher'**
  String get occupation_teacher;

  /// No description provided for @occupation_doctor.
  ///
  /// In en, this message translates to:
  /// **'Doctor'**
  String get occupation_doctor;

  /// No description provided for @occupation_engineer.
  ///
  /// In en, this message translates to:
  /// **'Engineer'**
  String get occupation_engineer;

  /// No description provided for @occupation_defense.
  ///
  /// In en, this message translates to:
  /// **'Defense'**
  String get occupation_defense;

  /// No description provided for @occupation_retired.
  ///
  /// In en, this message translates to:
  /// **'Retired'**
  ...
  /// In en, this message translates to:
  /// **'Not Working'**
  String get occupation_not_working;

  /// No description provided for @occupation_other_occ.
  ///
  /// In en, this message translates to:
  /// **'Other'**
  String get occupation_other_occ;
}
