...
class ReviewResponse {
  ...
  ReviewResponse({this.result, this.data});
...
class ReviewData {
  ...
  ReviewData({this.bgImage, this.items});
...
class Item {
  ...
  Item({this.image, this.review});

  factory Item.fromJson(Map<String, dynamic> json) =>
      Item(image: json["image"], review: json["review"]);

  Map<String, dynamic> toJson() => {"image": image, "review": review};
}
