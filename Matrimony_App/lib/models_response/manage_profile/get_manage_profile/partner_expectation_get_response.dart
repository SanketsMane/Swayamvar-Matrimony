...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    childrenAcceptable: json["children_acceptable"]?.toString() ?? json["partner_children_acceptable"]?.toString(),
    residenceCountryId: json["residence_country_id"]?.toString(),
    ...
    manglik: json["manglik"]?.toString() ?? json["partner_manglik"]?.toString(),
    languageId: json["language"]?.toString(),
    familyValueId: json["family_value_id"]?.toString(),
    preferredCountryId: json["preferred_country_id"]?.toString(),
    preferredStateId: json["preferred_state_id"]?.toString(),
    complexion: json["complexion"],
    expectedIncome: json["expected_income"]?.toString() ?? json["partner_income"]?.toString(),
    partnerIntercaste: json["partner_intercaste"]?.toString() ?? json["intercaste"]?.toString(),
  );
