              ...
              ? ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (index ==
                    ...
                    return Center(
                      child:
                          state.referralWithdrawRequestHistoryState!.hasMore!
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            ...
            children: [
              Text('Recharge wallet', style: Styles.bold_arsenic_14),
          ...
          content: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text('Amount *', style: Styles.regular_arsenic_14),
                  Const.height10,
                  Expanded(
                    child: TextField(
              ...
              Row(
                ...
                mainAxisSize: MainAxisSize.max,
                children: [
                  Text('Details *', style: Styles.regular_arsenic_14),
                  Const.height18,
                  Expanded(
                    child: SizedBox(
                      height: 100,
