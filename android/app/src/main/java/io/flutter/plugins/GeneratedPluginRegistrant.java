...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.infogetter.app.info_getter.InfoGetterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin info_getter, com.infogetter.app.info_getter.InfoGetterPlugin", e);
    }
    try {
