...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(MemberController::class)->group(function () {
        Route::get('/members/member_list/{id}', 'index')->name('members.index_with_id');
        ...
        Route::get('/members/destroy/{id}', 'destroy')->name('members.destroy_with_id');
    ...
    Route::controller(ReportedUserController::class)->group(function () {
        ...
        Route::get('/reported/destroy/{id}', 'destroy')->name('report_destrot.destroy_link');
    });
    ...
    Route::controller(PackageController::class)->group(function () {
        ...
        Route::get('/packages/destroy/{id}', 'destroy')->name('packages.destroy_link');
    });
    ...
    Route::get('/blog-category/destroy/{id}', 'BlogCategoryController@destroy')->name('blog-category.destroy_link');

    Route::resource('blog', 'BlogController');
    Route::controller(BlogController::class)->group(function () {
        Route::get('/blog/destroy/{id}', 'destroy')->name('blog.destroy_link');
    ...
    Route::controller(ReligionController::class)->group(function () {
        Route::get('/religions/destroy/{id}', 'destroy')->name('religions.destroy_link');
    ...
    Route::controller(CasteController::class)->group(function () {
        Route::get('/castes/destroy/{id}', 'destroy')->name('castes.destroy_link');
    ...
    Route::controller(SubCasteController::class)->group(function () {
        Route::get('/sub-castes/destroy/{id}', 'destroy')->name('sub-castes.destroy_link');
    ...
    Route::get('/member-language/destroy/{id}', [MemberLanguageController::class, 'destroy'])->name('member-languages.destroy_link');

    // Country
    Route::resource('/countries', CountryController::class);
    Route::controller(CountryController::class)->group(function () {
        Route::post('/countries/status', 'updateStatus')->name('countries.status');
        Route::get('/countries/destroy/{id}', 'destroy')->name('countries.destroy_link');
    });
    

    // State
    Route::resource('/states', StateController::class);
    Route::get('/states/destroy/{id}', [StateController::class,'destroy'])->name('states.destroy_link');

    // City
    Route::resource('/cities', 'CityController');
    Route::get('/cities/destroy/{id}', 'CityController@destroy')->name('cities.destroy_link');

    // Family Status
    Route::resource('/family-status', 'FamilyStatusController');
    Route::get('/family-status/destroy/{id}', 'FamilyStatusController@destroy')->name('family-status.destroy_link');

    // Family Value
    Route::resource('/family-values', 'FamilyValueController');
    Route::get('/family-values/destroy/{id}', 'FamilyValueController@destroy')->name('family-values.destroy_link');

    // On Behalf
    Route::resource('/on-behalf', 'OnBehalfController');
    Route::get('/on-behalf/destroy/{id}', 'OnBehalfController@destroy')->name('on-behalf.destroy_link');

    Route::resource('marital-statuses', 'MaritalStatusController');
    Route::get('/marital-statuses/destroy/{id}', 'MaritalStatusController@destroy')->name('marital-statuses.destroy_link');
    ...
    Route::controller(LanguageController::class)->group(function () {
        ...
        Route::get('/languages/destroy/{id}', 'destroy')->name('languages.destroy_link');
    });
    ...
    Route::controller(SettingController::class)->group(function () {
        ...
        Route::post('/settings/activation/update', 'updateActivationSettings')->name('settings.activation.update_post');

        // Firebase Push Notification Setting
        Route::get('/settings/firebase/fcm', 'fcm_settings')->name('settings.fcm');
        Route::post('/settings/firebase/fcm', 'fcm_settings_update')->name('settings.fcm.update_post');
        ...
        Route::post('/payment_method_update', 'payment_method_update')->name('payment_method.update_post');
    
        Route::get('/third-party-settings', 'third_party_settings')->name('third_party_settings');
        Route::post('/third-party-settings/update', 'third_party_settings_update')->name('third_party_settings.update_post');
        ...
        // env Update
        Route::post('/env_key_update', 'env_key_update')->name('env_key_update.update_post');

        Route::get('/verification/form', 'member_verification_form')->name('member_verification_form.index');
        Route::post('/verification/form/update', 'member_verification_form_update')->name('member_verification_form.update_post');
    ...
    Route::controller(CurrencyController::class)->group(function () {
        ...
        Route::get('/currency/destroy/{id}', 'destroy')->name('currency.destroy_link');
    });
    ...
    Route::group(['prefix' => 'website'], function () {
        ...
        Route::controller(PageController::class)->group(function () {
            Route::get('/custom-pages/edit/{id}', 'edit')->name('custom-pages.edit_page');
            Route::get('/custom-pages/destroy/{id}', 'destroy')->name('custom-pages.destroy_link');
        });
    });

    Route::resource('staffs', 'StaffController');
    Route::get('/staffs/destroy/{id}', 'StaffController@destroy')->name('staffs.destroy_link');

    Route::resource('roles', 'RoleController');
    Route::get('/roles/destroy/{id}', 'RoleController@destroy')->name('roles.destroy_link');
    ...
    Route::controller(AizUploadController::class)->group(function() {
        ...
        Route::get('/uploaded-files/destroy/{id}', 'destroy')->name('uploaded-files.destroy_link');
    ...
    Route::get('/manual_payment_methods/destroy/{id}', [ManualPaymentMethodController::class, 'destroy'])->name('manual_payment_methods.destroy_link');
});
