...
Route::group(['namespace' => 'Api', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['auth:sanctum', 'api_email_verified', 'api_member']], function () {
        ...
        Route::group(['namespace' => 'Payment'], function () {
            ...
            // Razor Pay
            Route::any('pay-with-razorpay', 'RazorpayController@payWithRazorpay')->name('api.pay.with.razorpay');
        ...
        Route::group(['prefix' => 'member'], function () {
            ...
            Route::apiResource('gallery-image', 'GalleryImageController', ['as' => 'member']);
            Route::apiResource('career', 'CareerController', ['as' => 'member']);
            Route::apiResource('education', 'EducationController', ['as' => 'member']);
            Route::apiResource('support-ticket', 'SupportTicketController', ['as' => 'member']);
