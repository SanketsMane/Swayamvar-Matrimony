...
class PartnerExpectationResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'height' => $this->height,
            'weight' => $this->weight,
            'marital_status_id' => $this->marital_status_id ? (int)$this->marital_status_id : '',
            'marital_status' => $marital_status ? $marital_status->name : null,
            'children_acceptable' => $this->children_acceptable ? 1 : 0,
            'residence_country_id' => $this->residence_country_id ? (int)$this->residence_country_id : '',
            ...
            'language_id' => $this->language_id ? (int)$this->language_id : '',
            ...
            'preferred_country_id' => $this->preferred_country_id ? (int)$this->preferred_country_id : '',
            'preferred_country' => $preferred_country ? $preferred_country->name : '',
            'preferred_state_id' => $this->preferred_state_id ? (int)$this->preferred_state_id : '',
