...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'name', 'email', 'password', 'code', 'phone','membership','approved', 'verification_code','fcm_token','referred_by','email_verified_at', 'photo', 'blocked', 'deactivated', 'user_type'
    ];
    ...
    public function telecaller_detail()
    {
