...
Route::group(['prefix' => 'support'], function(){
	...
	Route::get('/support-ticket/destroy/{id}', 'SupportTicketController@destroy')->name('support-tickets.destroy_link');
...
Route::post('support-ticket/store', 'SupportTicketController@store')->name('support-ticket.store_post');
