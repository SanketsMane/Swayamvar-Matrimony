...
Route::post('/password/reset/email/submit', 'HomeController@reset_password_with_code')->name('password.update_code');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/education/create', 'EducationController@create')->name('education.create_post');
    Route::post('/education/edit', 'EducationController@edit')->name('education.edit_post');
    ...
    Route::get('/education/destroy/{id}', 'EducationController@destroy')->name('education.destroy_link');

    // Member Career
    Route::resource('/career', 'CareerController');
    Route::post('/career/create', 'CareerController@create')->name('career.create_post');
    Route::post('/career/edit', 'CareerController@edit')->name('career.edit_post');
    ...
    Route::get('/career/destroy/{id}', 'CareerController@destroy')->name('career.destroy_link');
...
Route::controller(ContactUsController::class)->group(function () {
    ...
    Route::post('/contact-us', 'store')->name('contact-us.store_message');
});
...
Route::get('/customer-products/admin', 'HomeController@profile_edit')->name('customer_products.admin_profile_edit');
