...
class ProfilePictureViewCard extends StatelessWidget {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text('$age years', style: Styles.regular_arsenic_14),
                      ],
                    ),
                    const Spacer(),
                    Column(
                        ...
                        status == 1
                            ...
                            : Row(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    store.state.pictureProfileViewState!.index =
                                        index;
  ...
  Future<void> profile_picture_accept_reject_show_dialog(
    mainContext, {
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                isAcceptOrReject
                    ? store.dispatch(
                      profilePictureViewRequestAcceptMiddleware(id: request_id),
                    )
                    : store.dispatch(
                      profilePictureViewRequestRejectMiddleware(id: request_id),
                    );
