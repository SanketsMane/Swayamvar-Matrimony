...
class Styles {
  // Sanket: 2026 Premium Typography System
  static const String font_family_en = 'Poppins'; // Using Poppins as a modern Inter alternative if Inter is not bridged
  static const String font_family_mr = 'Noto Sans Devanagari'; // Using Noto Sans Devanagari as Hind/Mukta alternative
  ...
  static Color luxury_gold = MyTheme.primary; // Or a variation, but primary is fine for now
  ...
  // Legacy Styles (Re-mapped to new system for stability)
  ...
  static TextStyle bold_white_12 = caption.copyWith(color: MyTheme.white, fontWeight: FontWeight.bold);
  static TextStyle bold_arsenic_12 = caption.copyWith(color: MyTheme.text_primary, fontWeight: FontWeight.bold);
  static TextStyle bold_app_accent_12 = caption.copyWith(color: MyTheme.primary, fontWeight: FontWeight.bold);
  ...
  static TextStyle medium_white_12 = caption.copyWith(color: MyTheme.white, fontWeight: FontWeight.w500);
  ...
  static TextStyle bold_white_14 = body.copyWith(color: MyTheme.white, fontWeight: FontWeight.bold);
  static TextStyle bold_arsenic_14 = body.copyWith(fontWeight: FontWeight.bold);
  static TextStyle bold_app_accent_14 = body.copyWith(color: MyTheme.primary, fontWeight: FontWeight.bold);
  ...
  static TextStyle regular_gull_grey_16 = h2.copyWith(fontSize: 16, fontWeight: FontWeight.normal);
  static TextStyle bold_white_16 = h2.copyWith(color: MyTheme.white, fontSize: 16);
  static TextStyle bold_arsenic_16 = h2.copyWith(fontSize: 16);
  static TextStyle bold_app_accent_16 = h2.copyWith(color: MyTheme.primary, fontSize: 16);
