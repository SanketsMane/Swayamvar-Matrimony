...
class LanguageGetResponse {
  LanguageGetResponse({this.result, this.data});
...
class Data {
  Data({this.motherTongue, this.knownLanguages});
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    motherTongue:
        json["mother_tongue"] != null
            ? MotherTongue.fromJson(json["mother_tongue"])
            : null,
    knownLanguages:
        json["known_languages"] == null
            ? []
            : List<DDown>.from(
...
class MotherTongue {
  ...
  MotherTongue.initialState() : id = 0, name = '';
}
