...
ManageProfileCombineState manage_profile_combine_reducer(
  ManageProfileCombineState? state,
  dynamic action,
) {
  ...
  return ManageProfileCombineState(
    ...
    attributeBehaviorState: attitude_behavior_reducer(
      state.attributeBehaviorState,
      action,
    ),
    ...
    spiritualSocialState: spiritual_reducer(state.spiritualSocialState, action),
    partnerExpectationState: partner_expectation_reducer(
      state.partnerExpectationState,
      action,
    ),
