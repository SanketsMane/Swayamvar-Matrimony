    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0 fs-14">{{ translate('Conversion Overview') }}</h6>
            </div>
            <div class="card-body">
                <p class="text-muted">{{translate('Quick view of campaign metrics and agent productivity.')}}</p>
                <div class="text-center p-5">
                    <i class="las la-chart-bar la-3x text-muted mb-3"></i>
                    <p>{{translate('More detailed analytics available in the Reports section.')}}</p>
                    <a href="{{ route('telecalling.reports') }}" class="btn btn-primary">{{translate('View Detailed Reports')}}</a>
                </div>
            </div>
        </div>
    </div>
