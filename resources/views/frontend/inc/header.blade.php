                ...
                <div class="col-lg-7 col">
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                        ...
                        <li class="list-inline-item mx-4">
                            @php
                                $dashboard_route = (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff') ? route('admin.dashboard') : route('dashboard');
                            @endphp
                            <a href="{{ $dashboard_route }}" class="d-flex align-items-center text-reset">
